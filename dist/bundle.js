...
function main() {
  const main = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    type: 'main',
    classes: 'min-h-screen dark:text-primary text-black container mx-auto grid grid-cols-1 grid-rows-12 mt-20',
    id: 'main'
  });
  return main;
}
